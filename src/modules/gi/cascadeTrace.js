...
import { Fn, If, Loop, Return, float, floor, instanceIndex, instancedArray, mod, uniform, vec3, vec4 } from "three/tsl";
// The octahedral map moved to `srcOctahedral.js` — it outlives this file (§5
// keeps it for SRC's irradiance tiles), and one definition beats two that drift.
import { octahedralDirection } from "./srcOctahedral.js";
